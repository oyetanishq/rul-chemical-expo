...
const FEATURE_METADATA = [
    { key: "cycle_index", label: "Cycle Index (N)", unit: "cycles" },
    { key: "discharge_time", label: "Discharge Time (s)", unit: "seconds" },
    { key: "decrement", label: "Decrement 3.6-3.4V (s)", unit: "seconds" },
    { key: "max_voltage_discharge", label: "Max. Voltage Discharge (V)", unit: "Volts" },
    { key: "min_voltage_dcharge", label: "Min. Voltage Dcharge (V)", unit: "Volts" },
    { key: "time_at_4_15", label: "Time at 4.15V (s)", unit: "seconds" },
    { key: "time_constant_current", label: "Time Constant Current (s)", unit: "seconds" },
    { key: "charging_time", label: "Charging Time (s)", unit: "seconds" },
] as const;
